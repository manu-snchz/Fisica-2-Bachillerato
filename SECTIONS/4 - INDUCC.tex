...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.1]{INDUCC_SITUACIONESFLUJO}
...
\begin{wrapfigure}{R}{0.40\textwidth}
	\centering
	\includegraphics[scale=0.25]{INDUCC_FARADAY-LENZ}
	\caption{Faraday-Lenz}
	\label{INDUCC_FARADAY-LENZ}
\end{wrapfigure}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.15]{INDUCC_EXPERIENCIAHENRY}
	\caption{}
