...
\subsubsection{Inducción Mutua y Autoinducción}

\paragraph{Inducción Mutua}

Se produce una \textbf{inducción mutua} cuando dos circuitos son capaces de \textbf{inducir} corriente el \textbf{uno} en el \textbf{otro}. 



\begin{mybox}{Conceptos Clave}
	\begin{itemize}
