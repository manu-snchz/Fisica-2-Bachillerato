...
\begin{enumerate}
    ...
    \item $\varphi$: \textbf{Fase de la onda}. Es la magnitud adimensional que determina el estado de vibración de un punto del medio en un instante dado. Definido por: $\varphi = \omega \cdot t \pm k \cdot x + \varphi_0$. Se mide en radianes ($\unit{\radian}$).
