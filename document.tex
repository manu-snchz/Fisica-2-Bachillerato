...
La frecuencia en la que hay que cambiar la \textbf{polaridad} de la corriente en el ciclotrón, es el periodo de la partícula dividido entre 2. A esta frecuencia se llama \textbf{frecuencia de radiofrecuencia}: $\frac{T}{2} = \frac{\pi m}{\left| q \right|B}$:
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{
		...
		\textsc{Frecuencia de Radiofrecuencia} & $\displaystyle f_{\textnormal{rf}} = \frac{|q|B}{\pi m}$ & \unit{\hertz} \\
