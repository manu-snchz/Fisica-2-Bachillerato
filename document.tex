...
\begin{equation}\label{MAGN_CAMPOCREADOHILO}
...
Sustituyendo la ecuación \ref{MAGN_CAMPOCREADOHILO1} en la ecuación \ref{MAGN_FUERZAHILO2}:
...
Hasta el año 2019, el amperio (la intensidad de la corriente), se definía sobre la base de la fuerza de interacción magnética entre dos conductores rectilíneos paralelos. Si $I_1 = I_2 = \SI{1}\ampere$ y $d = \SI{1}\metre$, dado que $\mu = 4 \pi \cdot 10^{-7} \unit{\newton\per\ampere\squared}$:
