...
La frecuencia a la que hay que cambiar la \textbf{polaridad} se llama \textbf{frecuencia de radiofrecuencia}: $\frac{T}{2} = \frac{\pi m}{\left| q \right|B}$:

\begin{equation}
	f_{\textnormal{radiofrecuencia}} = \frac{\left| q \right|B}{2\pi m}
\end{equation}
